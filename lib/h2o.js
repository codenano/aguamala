                ...
                var c = new Crawler({
                   ...
                   "callback":function(error,result, $) {
                      $("html a").each(function(index,a) {
                          console.log(a.href.toString());
                           var log = {
                             type: 'start',
                             crawled: a.href.toString()
                             };
                           ws.send(JSON.stringify(log));
                      });
/*                      $('#login_email').val('sada@asd.asd');
                      $('#login_password').val('asdasdasdasd');
                      console.log($('input[type=submit]').val());*/
                      //https://www.paypal.com/us/cgi-bin/webscr?cmd=_login-submit&dispatch=5885d80a13c0db1f8e263663d3faee8d8cdcf517b037b4502f6cc98f1ee6e5fb
                      }
                   });
                //c.queue('http://servicio.mercadolibre.com.ve/MLV-420127669-desarrollo-web-y-soluciones-informaticas-_JM');
               break;
               default:
                 var menu =
                       [
